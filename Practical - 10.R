...
Conclusion 
The analysis successfully explored customer demographics, purchasing behavior, and 
income patterns using R programming. Statistical and graphical techniques helped identify 
meaningful business insights. Correlation analysis revealed a positive relationship between 
income and spending behavior. Hypothesis testing confirmed statistically significant 
differences in customer patterns. 
The study demonstrates how R programming can be effectively used for: 
  • Data preprocessing  
• Exploratory data analysis  
• Statistical testing  
• Visualization  
• Business decision support  
Overall, the project highlights the importance of data-driven analysis in understanding 
customer behavior and improving strategic business decisions.
